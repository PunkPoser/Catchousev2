...
const CommunityCard = ({ post, onComment }) => {
  ...
  return (
    <div className="bg-white rounded-3xl border border-gray-200 overflow-hidden mb-6">
      ...
      <div className="p-4">
        {/* Post Text */}
        <p className="text-gray-900 font-semibold text-base mb-4 leading-relaxed">
          {post.text}
        </p>
          ...
          <div className="flex items-center space-x-4">
            ...
            >
              ...
              <span className="text-gray-600 text-sm">{post.comments}</span>
                    ...
                    <button 
                      onClick={handleLike}
                      className={`flex items-center space-x-1 hover:bg-gray-50 px-2 py-1 rounded-lg transition-all duration-300 ${
                        isAnimating ? 'scale-110' : 'scale-100'
                      }`}
                    >
                      <svg xmlns="http://www.w3.org/2000/svg" fill={isLiked ? "currentColor" : "none"} viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={`w-4 h-4 transition-all duration-300 ${
